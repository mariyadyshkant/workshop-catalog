        ...
        <div class="card-body">
            <form method="POST" action="{{ route('courses.update', $course->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="requirements" class="form-control" rows="3">{{ old('requirements', $course->requirements) }}</textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="available_spots" class="form-control" min="0"
                            value="{{ old('available_spots', $course->available_spots) }}">
                    </div>
                </div>
                <div class="mb-3">
                    @if ($course->image)
